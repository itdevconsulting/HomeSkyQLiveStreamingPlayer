...
public sealed class SkyQService : IDisposable
{
    ...
    public SkyQService(IHttpClientFactory httpClientFactory, IHostEnvironment environment)
    {
    ...
    {
        var interfaces = GetPrivateInterfaces();
    ...
    private static List<PrivateInterface> GetPrivateInterfaces()
    {
